...
from models.verbItaliano.italiano_model import ItalianoOneVerb, Verbi
...
class VerbiRepository:
    ...
    def Edit(self, infinitivoPresente='', infinitivoPassato='', participioPresente='', participioPassato='',
        ...
        try:
            updating_query = f"update public.verbi set infinitivoPresente=%s, infinitivoPassato=%s, participioPresente=%s, participioPassato=%s, " \
                             ...
                             f"indicativoFuturoAnterioreLoro=%s, congiuntivoPresenteIo=%s, congiuntivoPresenteTu=%s, congiuntivoPresenteLui=%s," \
