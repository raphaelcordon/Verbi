...
class ApiUltralingua:
    def __init__(self, verbo):
        ...
        self.listVerbs = {}
        self.bringVerb()
        #for item in self.listVerbs:
        #    print(item)
        #print(self.listVerbs)
    ...
    def congiuntivoPassato(self, item):
        ...
        # PASSATO IO
        if item['partofspeech']['tense'] == 'presentperfectsubjunctive' and item['partofspeech']['person'] == 'first' and \
                item['partofspeech']['number'] == 'singular':
            verbo = {'congiuntivoPassatoIo': item['surfaceform']}
            self.listVerbs.update(verbo)

        # PASSATO TU
        if item['partofspeech']['tense'] == 'presentperfectsubjunctive' and item['partofspeech']['person'] == 'second' and \
                item['partofspeech']['number'] == 'singular':
            verbo = {'congiuntivoPassatoTu': item['surfaceform']}
            self.listVerbs.update(verbo)

        # PASSATO LUI
        if item['partofspeech']['tense'] == 'presentperfectsubjunctive' and item['partofspeech']['person'] == 'third' and \
                item['partofspeech']['number'] == 'singular':
