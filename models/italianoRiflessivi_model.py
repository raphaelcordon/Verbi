...
class Italiano:
    def __init__(self,  id, riflessivo, verbo,  tempo,  io,  tu,  lui,  noi,  voi,  loro):
        self.id = id
        self.riflessivo
        self.verbo = verbo
        self.tempo = tempo
...
class Verbi:
    def __init__(self,  id, riflessivo, infinitivoPresente, infinitivoPassato, participioPresente, participioPassato,
                 ...
                 congiuntivoPresenteIo, congiuntivoPresenteTu, congiuntivoPresenteLui,
